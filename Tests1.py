...
class MyTestCase(unittest.TestCase):    
    ...
    def test_1(self):
        for i in range (20):
            ...
            if m < n:
                m += n
            B = []                             # формируем вертикальную матрицу B
            for i in range(m): 
                b = [] 
                for j in range(n):  
        ...
        return self.assertEqual(B, MatrixTurn(B, m, n, 0))

    def test_2(self):
        for i in range (20):
            n = random.randint (0, 10)
            m = 2*random.randint (0, 20)
            if n < m:
                n += m
            B = []                             # формируем горизонтальную матрицу B
            for i in range(m): 
                b = [] 
                for j in range(n):  
                    b.append(str(random.randint(0,9)))  
    ...
    def test_3(self):
        for i in range (20):
            n = 2*random.randint (0, 10)
            m = n
            B = []                             # формируем квадратную матрицу B
            for i in range(m): 
                b = [] 
                for j in range(n):  
                    b.append(str(random.randint(0,9)))  
